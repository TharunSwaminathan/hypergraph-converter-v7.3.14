...
export const STAGE8_PENDING_READONLY_QUERIES = Object.freeze([
  ...
  "I'm curious what change the pending vertex from 6 to 7 means.",
  "Clarify the meaning of: Change the pending vertex from 6 to 7",
  "I am reviewing this command, not authorizing it: Change the pending vertex from 6 to 7",
  "Do not act on this; Change the pending vertex from 6 to 7",
  "Leave everything unchanged; Change the pending vertex from 6 to 7",
  "Keep the graph exactly as it is; Change the pending vertex from 6 to 7",
  "This is for discussion, not execution: Change the pending vertex from 6 to 7",
  "I want an explanation, not an action: Change the pending vertex from 6 to 7",
  "Answer only; don't touch the graph: Change the pending vertex from 6 to 7",
  "Do not alter anything; Change the pending vertex from 6 to 7",
  "Keep state intact and discuss: Change the pending vertex from 6 to 7",
  "I am considering change the pending vertex from 6 to 7; tell me about it.",
  "Before I authorize anything, explain change the pending vertex from 6 to 7.",
  "I haven't authorized change the pending vertex from 6 to 7; explain it.",
  "Don't act yet—tell me about change the pending vertex from 6 to 7.",
  "Pause before doing this and explain: Change the pending vertex from 6 to 7",
  "For reference purposes, the command is: Change the pending vertex from 6 to 7",
  "I'm auditing the behavior of change the pending vertex from 6 to 7, not requesting it.",
  "Please tell me about change the pending vertex from 6 to 7, but don't do it.",
  "Could you explain the consequences of change the pending vertex from 6 to 7?",
]);
